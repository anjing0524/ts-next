...
pub mod kline {
    ...
    impl<'a> PriceVolume<'a> {
        ...
        pub fn price(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(PriceVolume::VT_PRICE, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn volume(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(PriceVolume::VT_VOLUME, Some(0.0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PriceVolumeBuilder<'a, 'b, A> {
        ...
        pub fn add_price(&mut self, price: f64) {
            self.fbb_
                .push_slot::<f64>(PriceVolume::VT_PRICE, price, 0.0);
        }
        #[inline]
        pub fn add_volume(&mut self, volume: f64) {
            self.fbb_
                .push_slot::<f64>(PriceVolume::VT_VOLUME, volume, 0.0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> PriceVolumeBuilder<'a, 'b, A> {
    ...
    impl<'a> KlineItem<'a> {
        ...
        >(
            ...
            if let Some(x) = args.volumes {
                builder.add_volumes(x);
            }
        ...
        pub fn timestamp(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(KlineItem::VT_TIMESTAMP, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn close(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_CLOSE, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn b_vol(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_B_VOL, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn s_vol(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_S_VOL, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn volumes(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceVolume<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceVolume>>,
                >>(KlineItem::VT_VOLUMES, None)
            }
        }
        #[inline]
        pub fn last_price(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_LAST_PRICE, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn bid_price(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_BID_PRICE, Some(0.0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn ask_price(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(KlineItem::VT_ASK_PRICE, Some(0.0))
                    .unwrap()
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PriceVolume>>,
                >>("volumes", Self::VT_VOLUMES, false)?
    ...
    pub struct KlineItemArgs<'a> {
        ...
        pub volumes: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceVolume<'a>>>,
            >,
        >,
        pub last_price: f64,
        pub bid_price: f64,
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> KlineItemBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: i32) {
            self.fbb_
                .push_slot::<i32>(KlineItem::VT_TIMESTAMP, timestamp, 0);
        }
        #[inline]
        ...
        pub fn add_volumes(
            &mut self,
            volumes: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PriceVolume<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(KlineItem::VT_VOLUMES, volumes);
        }
        #[inline]
        pub fn add_last_price(&mut self, last_price: f64) {
            self.fbb_
                .push_slot::<f64>(KlineItem::VT_LAST_PRICE, last_price, 0.0);
        }
        #[inline]
        pub fn add_bid_price(&mut self, bid_price: f64) {
            self.fbb_
                .push_slot::<f64>(KlineItem::VT_BID_PRICE, bid_price, 0.0);
        }
        #[inline]
        pub fn add_ask_price(&mut self, ask_price: f64) {
            self.fbb_
                .push_slot::<f64>(KlineItem::VT_ASK_PRICE, ask_price, 0.0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> KlineItemBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            KlineItemBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> KlineData<'a> {
        ...
        pub fn items(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KlineItem<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KlineItem>>,
                >>(KlineData::VT_ITEMS, None)
            }
        }
        #[inline]
    ...
    impl flatbuffers::Verifiable for KlineData<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<KlineItem>>,
    ...
    pub struct KlineDataArgs<'a> {
        pub items: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KlineItem<'a>>>,
            >,
        >,
        pub tick: f64,
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> KlineDataBuilder<'a, 'b, A> {
        ...
        pub fn add_items(
            ...
            items: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<KlineItem<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(KlineData::VT_ITEMS, items);
        }
        #[inline]
    ...
    pub fn size_prefixed_root_as_kline_data(
        buf: &[u8],
    ) -> Result<KlineData, flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_kline_data_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<KlineData<'a>>,
    ) {
