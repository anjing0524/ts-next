...
async function main() {
  ...
  const permissionsData: Prisma.PermissionCreateInput[] = [
    ...
    { name: 'menu:dashboard:view', displayName: '查看仪表盘', description: '访问仪表盘页面', type: PermissionType.MENU, resource: '/dashboard', action: 'VIEW', isActive: true },
    { name: 'menu:system:view', displayName: '查看系统管理', description: '访问系统管理顶级菜单', type: PermissionType.MENU, resource: '/system', action: 'VIEW', isActive: true },
    { name: 'menu:system:user:view', displayName: '查看用户管理', description: '访问用户管理页面', type: PermissionType.MENU, resource: '/system/user', action: 'VIEW', isActive: true },
    { name: 'menu:system:role:view', displayName: '查看角色管理', description: '访问角色管理页面', type: PermissionType.MENU, resource: '/system/role', action: 'VIEW', isActive: true },
    { name: 'menu:system:permission:view', displayName: '查看权限管理', description: '访问权限管理页面', type: PermissionType.MENU, resource: '/system/permission', action: 'VIEW', isActive: true },
    { name: 'menu:system:menu:view', displayName: '查看菜单管理', description: '访问菜单管理页面', type: PermissionType.MENU, resource: '/system/menu', action: 'VIEW', isActive: true },
    { name: 'menu:system:client:view', displayName: '查看客户端管理', description: '访问OAuth客户端管理页面', type: PermissionType.MENU, resource: '/system/client', action: 'VIEW', isActive: true },
    { name: 'menu:system:audit:view', displayName: '查看审计日志', description: '访问审计日志页面', type: PermissionType.MENU, resource: '/system/audit', action: 'VIEW', isActive: true },
    { name: 'menu:system:config:view', displayName: '查看系统配置', description: '访问系统配置页面', type: PermissionType.MENU, resource: '/system/config', action: 'VIEW', isActive: true },
    { name: 'menu:system:policy:view', displayName: '查看安全策略', description: '访问安全策略页面', type: PermissionType.MENU, resource: '/system/policy', action: 'VIEW', isActive: true },
    { name: 'menu:profile:view', displayName: '查看个人资料', description: '访问个人资料页面', type: PermissionType.MENU, resource: '/profile', action: 'VIEW', isActive: true },

    // API权限 (API Permissions) - Section 3.1 / Section 8.2 SQL
    // User Management
    { name: 'user:list', displayName: '列出用户', description: '获取用户列表', type: PermissionType.API, resource: '/api/v2/users', action: 'GET', isActive: true },
    { name: 'user:create', displayName: '创建用户', description: '创建新用户', type: PermissionType.API, resource: '/api/v2/users', action: 'POST', isActive: true },
    { name: 'user:read', displayName: '读取用户', description: '获取单个用户信息', type: PermissionType.API, resource: '/api/v2/users/{userId}', action: 'GET', isActive: true },
    { name: 'user:update', displayName: '更新用户', description: '更新用户信息', type: PermissionType.API, resource: '/api/v2/users/{userId}', action: 'PUT', isActive: true },
    { name: 'user:delete', displayName: '删除用户', description: '删除用户', type: PermissionType.API, resource: '/api/v2/users/{userId}', action: 'DELETE', isActive: true },
    { name: 'user:status:update', displayName: '更新用户状态', description: '激活或停用用户账户', type: PermissionType.API, resource: '/api/v2/users/{userId}/status', action: 'PUT', isActive: true },
    { name: 'user:password:reset', displayName: '重置用户密码', description: '管理员重置用户密码', type: PermissionType.API, resource: '/api/v2/users/{userId}/password-reset', action: 'POST', isActive: true },
    { name: 'user:roles:list', displayName: '列出用户角色', description: '获取用户的角色列表', type: PermissionType.API, resource: '/api/v2/users/{userId}/roles', action: 'GET', isActive: true },
    { name: 'user:roles:assign', displayName: '分配用户角色', description: '为用户分配角色', type: PermissionType.API, resource: '/api/v2/users/{userId}/roles', action: 'POST', isActive: true },
    { name: 'user:roles:remove', displayName: '移除用户角色', description: '移除用户的角色', type: PermissionType.API, resource: '/api/v2/users/{userId}/roles/{roleId}', action: 'DELETE', isActive: true },
    { name: 'user:profile:read', displayName: '读取用户个人资料', description: '获取指定用户的个人资料', type: PermissionType.API, resource: '/api/v2/users/{userId}/profile', action: 'GET', isActive: true },
    { name: 'user:profile:update', displayName: '更新用户个人资料', description: '更新指定用户的个人资料', type: PermissionType.API, resource: '/api/v2/users/{userId}/profile', action: 'PUT', isActive: true },
    { name: 'users:permissions:verify', displayName: '验证用户权限', description: '批量验证用户是否拥有特定权限', type: PermissionType.API, resource: '/api/v2/users/{userId}/permissions/verify', action: 'POST', isActive: true },
    { name: 'users:permissions:read', displayName: '读取用户权限列表', description: '获取特定用户的有效权限列表', type: PermissionType.API, resource: '/api/v2/users/{userId}/permissions', action: 'GET', isActive: true },
    { name: 'users:lock', displayName: '锁定用户账户', description: '管理员锁定用户账户', type: PermissionType.API, resource: '/api/v2/users/{userId}/lock', action: 'POST', isActive: true },
    { name: 'users:unlock', displayName: '解锁用户账户', description: '管理员解锁用户账户', type: PermissionType.API, resource: '/api/v2/users/{userId}/unlock', action: 'POST', isActive: true },

    // Role Management
    { name: 'role:list', displayName: '列出角色', description: '获取角色列表', type: PermissionType.API, resource: '/api/v2/roles', action: 'GET', isActive: true },
    { name: 'role:create', displayName: '创建角色', description: '创建新角色', type: PermissionType.API, resource: '/api/v2/roles', action: 'POST', isActive: true },
    { name: 'role:read', displayName: '读取角色', description: '获取单个角色信息', type: PermissionType.API, resource: '/api/v2/roles/{roleId}', action: 'GET', isActive: true },
    { name: 'role:update', displayName: '更新角色', description: '更新角色信息', type: PermissionType.API, resource: '/api/v2/roles/{roleId}', action: 'PUT', isActive: true },
    { name: 'role:delete', displayName: '删除角色', description: '删除角色', type: PermissionType.API, resource: '/api/v2/roles/{roleId}', action: 'DELETE', isActive: true },
    { name: 'role:permissions:list', displayName: '列出角色权限', description: '获取角色的权限列表', type: PermissionType.API, resource: '/api/v2/roles/{roleId}/permissions', action: 'GET', isActive: true },
    { name: 'role:permissions:assign', displayName: '分配角色权限', description: '为角色分配权限', type: PermissionType.API, resource: '/api/v2/roles/{roleId}/permissions', action: 'POST', isActive: true },
    { name: 'role:permissions:remove', displayName: '移除角色权限', description: '移除角色的权限', type: PermissionType.API, resource: '/api/v2/roles/{roleId}/permissions/{permissionId}', action: 'DELETE', isActive: true },

    // Permission Management
    { name: 'permission:list', displayName: '列出权限定义', description: '获取所有已定义的权限列表', type: PermissionType.API, resource: '/api/v2/permissions', action: 'GET', isActive: true },
    { name: 'permission:create', displayName: '创建权限定义', description: '创建新的权限定义', type: PermissionType.API, resource: '/api/v2/permissions', action: 'POST', isActive: true },
    { name: 'permission:read', displayName: '读取权限定义', description: '获取特定权限定义的详细信息', type: PermissionType.API, resource: '/api/v2/permissions/{permissionId}', action: 'GET', isActive: true },
    { name: 'permission:update', displayName: '更新权限定义', description: '更新现有权限定义的信息', type: PermissionType.API, resource: '/api/v2/permissions/{permissionId}', action: 'PUT', isActive: true },
    { name: 'permission:delete', displayName: '删除权限定义', description: '删除一个权限定义', type: PermissionType.API, resource: '/api/v2/permissions/{permissionId}', action: 'DELETE', isActive: true },

    // OAuth Client Management
    { name: 'client:list', displayName: '列出客户端', description: '获取OAuth客户端列表', type: PermissionType.API, resource: '/api/v2/clients', action: 'GET', isActive: true },
    { name: 'client:create', displayName: '创建客户端', description: '创建新OAuth客户端', type: PermissionType.API, resource: '/api/v2/clients', action: 'POST', isActive: true },
    { name: 'client:read', displayName: '读取客户端', description: '获取单个OAuth客户端信息', type: PermissionType.API, resource: '/api/v2/clients/{clientId}', action: 'GET', isActive: true },
    { name: 'client:update', displayName: '更新客户端', description: '更新OAuth客户端信息', type: PermissionType.API, resource: '/api/v2/clients/{clientId}', action: 'PUT', isActive: true },
    { name: 'client:delete', displayName: '删除客户端', description: '删除OAuth客户端', type: PermissionType.API, resource: '/api/v2/clients/{clientId}', action: 'DELETE', isActive: true },

    // Audit Log Management
    { name: 'audit:list', displayName: '列出审计日志', description: '获取审计日志列表', type: PermissionType.API, resource: '/api/v2/audits', action: 'GET', isActive: true },
    { name: 'audit:read', displayName: '读取审计日志', description: '获取单个审计日志详情', type: PermissionType.API, resource: '/api/v2/audits/{logId}', action: 'GET', isActive: true },

    // System Configuration Management
    { name: 'config:list', displayName: '列出系统配置', description: '获取系统配置项列表', type: PermissionType.API, resource: '/api/v2/system-configurations', action: 'GET', isActive: true },
    { name: 'config:read', displayName: '读取系统配置', description: '获取单个系统配置项', type: PermissionType.API, resource: '/api/v2/system-configurations/{key}', action: 'GET', isActive: true },
    { name: 'config:update', displayName: '更新系统配置', description: '更新系统配置项', type: PermissionType.API, resource: '/api/v2/system-configurations/{key}', action: 'PUT', isActive: true },

    // Security Policy Management
    { name: 'policy:list', displayName: '列出安全策略', description: '获取安全策略列表', type: PermissionType.API, resource: '/api/v2/security-policies', action: 'GET', isActive: true },
    { name: 'policy:read', displayName: '读取安全策略', description: '获取单个安全策略', type: PermissionType.API, resource: '/api/v2/security-policies/{policyId}', action: 'GET', isActive: true },
    { name: 'policy:update', displayName: '更新安全策略', description: '更新安全策略', type: PermissionType.API, resource: '/api/v2/security-policies/{policyId}', action: 'PUT', isActive: true },

    // Current User Profile (Self-service)
    { name: 'profile:me:read', displayName: '读取我的个人资料', description: '获取当前用户的个人资料', type: PermissionType.API, resource: '/api/v2/profile/me', action: 'GET', isActive: true },
    { name: 'profile:me:update', displayName: '更新我的个人资料', description: '更新当前用户的个人资料', type: PermissionType.API, resource: '/api/v2/profile/me', action: 'PUT', isActive: true },
    { name: 'profile:me:password:change', displayName: '修改我的密码', description: '当前用户修改自己的密码', type: PermissionType.API, resource: '/api/v2/profile/me/password', action: 'POST', isActive: true },
  ...
  const rolePermissionsMapping: Record<string, string[]> = {
    USER_ADMIN: [
      'menu:system:user:view', 'user:list', 'user:create', 'user:read', 'user:update', 'user:status:update',
      'user:password:reset', 'user:roles:list', 'user:roles:assign', 'user:roles:remove',
      'user:profile:read', 'user:profile:update', 'users:permissions:verify',
      'users:permissions:read', 'users:lock', 'users:unlock', // Added new permissions for USER_ADMIN
    ],
    PERMISSION_ADMIN: [
      'menu:system:role:view', 'menu:system:permission:view', // Menu permissions
      'role:list', 'role:create', 'role:read', 'role:update', 'role:delete', // Role CRUD
      'role:permissions:list', 'role:permissions:assign', 'role:permissions:remove', // Role-Permission assignment
      'permission:list', 'permission:create', 'permission:read', 'permission:update', 'permission:delete', // Permission definition CRUD
    ],
    CLIENT_ADMIN: [
      'menu:system:client:view',
      'client:list', 'client:create', 'client:read', 'client:update', 'client:delete',
    ],
    AUDIT_ADMIN: [
    ...
    USER: [ // Basic user permissions
      'menu:dashboard:view', 'menu:profile:view',
      'profile:me:read', 'profile:me:update', 'profile:me:password:change',
  ...
  if (systemAdminRole) {
    for (const permName in seededPermissions) { // This loop already includes the new 'auth-center:interact'
      const permission = seededPermissions[permName];
      await prisma.rolePermission.upsert({
    ...
    console.log(`所有权限已分配给角色 '${systemAdminRole.name}' (All permissions assigned to role '${systemAdminRole.name}')`);
  } else {
    console.warn('SYSTEM_ADMIN 角色未找到，无法分配所有权限。(SYSTEM_ADMIN role not found, cannot assign all permissions.)');
  }
  ...
  }).catch((e) => console.warn(`为用户 ${adminUser.username} 添加密码历史失败，可能已存在: ${e.message}`));
  ...
  console.log('正在填充 Scopes...'); // Seeding Scopes...
    ...
    { name: 'admin:full_access', description: '完全管理权限 (粗粒度)', isPublic: false, isActive: true },
  ];
  for (const scopeData of scopesToSeed) {
    await prisma.scope.upsert({
      where: { name: scopeData.name },
      update: { description: scopeData.description, isPublic: scopeData.isPublic, isActive: scopeData.isActive },
      create: scopeData,
    });
  }
  ...
  for (const userData of usersToSeed) {
    ...
    if (userRole && (createdUser.username === 'testuser' || createdUser.username === 'changepwuser')) {
      await prisma.userRole.upsert({
  ...
  console.log(`OAuth客户端已更新/创建: auth-center-admin-client (原始密钥: ${adminClientSecretRaw})`); // OAuth client upserted/created
