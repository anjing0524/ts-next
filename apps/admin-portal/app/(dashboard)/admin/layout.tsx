...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebarLoadingFallback = (
    <div
      className={cn(
        'w-64 p-4 bg-background dark:bg-slate-800 border-r dark:border-slate-700 print:hidden',
        isMobile && 'w-72'
      )}
    >
  ...
  return (
    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40 dark:bg-muted">
      {' '}
      {/* Changed dark mode to dark:bg-muted */}
      <SiteHeader
        brandName="管理后台"
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-6 print:p-0">
          {' '}
          {/* Adjusted padding */}
          {children}
        </main>
