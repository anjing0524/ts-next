 ...
 */
async function getSingleSystemConfigurationHandler(request: NextRequest, context: RouteContext) {
 ...
 */
async function updateSingleSystemConfigurationHandler(request: NextRequest, context: RouteContext) {
  const { configKey } = context.params;
