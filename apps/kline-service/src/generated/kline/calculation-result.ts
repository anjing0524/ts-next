...
export class CalculationResult {
  ...
  static getRootAsCalculationResult(
  ...
  static getSizePrefixedRootAsCalculationResult(
    bb: flatbuffers.ByteBuffer,
    obj?: CalculationResult
  ): CalculationResult {
  ...
  static createBollingerUpperVector(
    builder: flatbuffers.Builder,
    data: number[] | Float64Array
  ): flatbuffers.Offset;
  /**
  ...
  static createBollingerLowerVector(
    builder: flatbuffers.Builder,
    data: number[] | Float64Array
  ): flatbuffers.Offset;
  /**
  ...
  static createCalculationResult(
    builder: flatbuffers.Builder,
    smaOffset: flatbuffers.Offset,
    emaOffset: flatbuffers.Offset,
    rsiOffset: flatbuffers.Offset,
    macdOffset: flatbuffers.Offset,
    bollingerUpperOffset: flatbuffers.Offset,
    bollingerLowerOffset: flatbuffers.Offset
  ): flatbuffers.Offset {
