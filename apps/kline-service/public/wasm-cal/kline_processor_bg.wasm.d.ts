...
export const klineprocess_append_data: (a: number, b: number, c: number) => [number, number];
export const klineprocess_get_last_sequence: (a: number) => number;
export const klineprocess_merge_data: (a: number, b: number, c: number) => [number, number];
