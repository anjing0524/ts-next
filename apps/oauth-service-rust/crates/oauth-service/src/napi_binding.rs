...
impl NapiOAuthSDK {
    ...
    #[napi]
    pub async fn user_update_profile(&self, data: serde_json::Value) -> Result<serde_json::Value> {
        let profile: crate::napi::modules::user::UpdateProfileRequest =
    ...
    #[napi]
    pub async fn rbac_get_permissions(&self, page: Option<i32>, page_size: Option<i32>) -> Result<serde_json::Value> {
    ...
    #[napi]
    pub async fn rbac_get_roles(&self, page: Option<i32>, page_size: Option<i32>) -> Result<serde_json::Value> {
        let result = self.sdk.rbac
    ...
    #[napi]
    pub async fn rbac_assign_role(&self, user_id: String, role_id: String) -> Result<serde_json::Value> {
        let result = self.sdk.rbac
    ...
    #[napi]
    pub async fn client_list(&self, page: Option<i32>, page_size: Option<i32>) -> Result<serde_json::Value> {
    ...
    #[napi]
    pub async fn client_get(&self, client_id: String) -> Result<serde_json::Value> {
        let result = self.sdk.client
    ...
    #[napi]
    pub async fn audit_get_logs(&self, page: Option<i32>, page_size: Option<i32>) -> Result<serde_json::Value> {
    ...
    /// * `Result<serde_json::Value>` - 审计日志数据 (Audit Logs Data)
    #[napi]
    pub async fn audit_get_user_logs(&self, user_id: String, page: Option<i32>, page_size: Option<i32>) -> Result<serde_json::Value> {
        let result = self.sdk.audit
