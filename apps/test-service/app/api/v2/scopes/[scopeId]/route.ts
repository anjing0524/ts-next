 ...
 */
async function getScopeHandler(request: AuthenticatedRequest, context: RouteContext) {
 ...
 */
async function patchScopeHandler(request: AuthenticatedRequest, context: RouteContext) {
  const { scopeId } = context.params;
 ...
 */
async function deleteScopeHandler(request: AuthenticatedRequest, context: RouteContext) {
  const { scopeId } = context.params;
