...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (existingEntry) {
      ...
      return NextResponse.json(
        { message: 'JTI already blacklisted.', jti: existingEntry.jti, expiresAt: existingEntry.expiresAt },
    ...
    return NextResponse.json(
      { message: 'Token JTI successfully blacklisted.', jti: newBlacklistEntry.jti, tokenType: newBlacklistEntry.tokenType, expiresAt: newBlacklistEntry.expiresAt },
