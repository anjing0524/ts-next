...
export declare abstract class BaseError extends Error {
     ...
     */
    log(logger?: Pick<Console, 'error'>, additionalContext?: Record<string, any>): void;
}
/**
...
export declare class OAuth2Error extends BaseError {
     ...
     * @param context 可选的附加上下文数据。 (Optional additional contextual data.)
     */
    constructor(message: string, oauth2ErrorCode: OAuth2ErrorCode, status?: number, // OAuth错误通常是400或401 (OAuth errors are typically 400 or 401)
    errorUri?: string, context?: Record<string, any>);
    /**
