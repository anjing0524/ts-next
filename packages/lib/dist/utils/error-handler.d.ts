 ...
 */
declare function logError(error: Error | BaseError | any, req?: NextRequest, requestId?: string): void;
/**
 ...
 */
declare function handleError(error: Error | any, req?: NextRequest, requestId?: string): NextResponse;
/**
 ...
 * ```
 */
declare function withErrorHandling<T extends NextRequest, P = any>(handler: (req: T, params?: P) => Promise<NextResponse>): (req: T, params?: P) => Promise<NextResponse>;
/**
 ...
 * ```
 */
declare function safeExecute<T>(fn: () => Promise<T> | T, failureMessage?: string, ErrorType?: new (...args: any[]) => BaseError): Promise<{
    data?: T;
    error?: BaseError;
}>;
/**
 ...
 */
declare function withErrorHandler(handler: RouteHandler): RouteHandler;
/**
 * 错误响应处理
 * Error response handling
 */
declare function errorResponse(message: string, status: number, errorCode?: string): NextResponse<{
    success: boolean;
    error: string;
    message: string;
}>;
 ...
 */
declare function successResponse(data: any, message?: string, status?: number): NextResponse<{
    success: boolean;
    data: any;
    message: string;
}>;

export { type RouteHandler, errorResponse, handleError, logError, safeExecute, successResponse, withErrorHandler, withErrorHandling };
