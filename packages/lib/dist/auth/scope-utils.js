...
class ScopeUtils {
     ...
     */
    static hasScope(userScopes, requiredScope) {
     ...
     */
    static hasAnyScope(userScopes, requiredScopes) {
     ...
     */
    static hasAllScopes(userScopes, requiredScopes) {
     ...
     */
    static isValidScopeFormat(scope) {
     ...
     */
    static validateScopeFormats(scopes) {
    ...
    static validateScopes(requestedScopes, allowedScopesOrClient) {
     ...
     */
    static filterValidScopes(requestedScopes, allowedScopes) {
     ...
     */
    static isOpenIdConnectScope(scope) {
     ...
     */
    static extractOpenIdConnectScopes(scopes) {
     ...
     */
    static extractCustomScopes(scopes) {
        return scopes.filter(scope => !this.isOpenIdConnectScope(scope));
    }
    /**
     ...
     */
    static isOpenIdConnectRequest(scopes) {
     ...
     */
    static intersectScopes(scopes1, scopes2) {
     ...
     */
    static unionScopes(scopes1, scopes2) {
     ...
     */
    static differenceScopes(scopes1, scopes2) {
        return scopes1.filter(scope => !scopes2.includes(scope));
    }
}
