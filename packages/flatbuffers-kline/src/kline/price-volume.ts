...
static getSizePrefixedRootAsPriceVolume(bb:flatbuffers.ByteBuffer, obj?:PriceVolume):PriceVolume {
...
static createPriceVolume(builder:flatbuffers.Builder, price:number, volume:number):flatbuffers.Offset {
