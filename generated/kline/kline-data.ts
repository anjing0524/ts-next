...
items(index: number, obj?:KlineItem):KlineItem|null {
  ...
  return offset ? (obj || new KlineItem()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static finishSizePrefixedKlineDataBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'KLI1', true);
}

static createKlineData(builder:flatbuffers.Builder, itemsOffset:flatbuffers.Offset, tick:number):flatbuffers.Offset {
